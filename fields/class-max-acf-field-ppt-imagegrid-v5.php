...
if( !class_exists('max_acf_field_ppt_imagegrid') ) :


class max_acf_field_ppt_imagegrid extends acf_field {
	...
	*/
	...
	function __construct( $settings ) {
		...
		*/
		...
		$this->label = __('Particitype Image Grid', 'ppt-imagegrid');
		...
		*  var message = acf._e('ppt_imagegrid', 'error');
		*/
	...
	function render_field_settings( $field ) {
		...
		*/
		...
		acf_render_field_setting( $field, array(
			'label'			=> __('Font Size','ppt-imagegrid'),
			'instructions'	=> __('Customise the input font size','ppt-imagegrid'),
			'type'			=> 'number',
			'name'			=> 'font_size',
			'prepend'		=> 'px',
		));
		...
		*/
        ...
        <div class='table'>
            <transition-group name="list" tag="div">
                ...
                <ul class="row table-actions" key='actions'>
                    <a href='#1' class='btn' id="addRow">Add Row</a>
                    <a href='#1' class='btn' id="addCol">Add Column</a>
                    <a href='#1' class='btn' id="removeCol">Remove Column</a>
                </ul>
            </transition-group>
	...
	*/
	...
	function input_admin_enqueue_scripts() {
		...
		// register & include JS
		wp_register_script('ppt-imagegrid', "{$url}assets/js/input.js", array('acf-input'), $version);
		wp_register_script('vue', "https://cdn.jsdelivr.net/npm/vue/dist/vue.js", array('acf-input'), null);
		wp_enqueue_script('ppt-imagegrid');
		wp_enqueue_script('vue');
		
		
		// register & include CSS
		wp_register_style('ppt-imagegrid', "{$url}assets/css/input.css", array('acf-input'), $version);
		wp_enqueue_style('ppt-imagegrid');
...
// initialize
new max_acf_field_ppt_imagegrid( $this->settings );
